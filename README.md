...
This project focuses on implementing and analyzing ZIP Trees, a novel data structure described in the referenced research paper. ZIP Trees combine the properties of binary search trees with randomized ranks to maintain balance through efficient "zipping" and "unzipping" operations rather than traditional rotations used in AVL or red-black trees.

Our implementation includes the core operations: insertion, deletion, and search, each adhering to the principles outlined in the paper. Insertion involves assigning a random rank to a new node and restructuring the tree to maintain heap order and binary search properties. Deletion ensures the tree's integrity by merging subtrees while preserving these properties, and search operations mimic standard binary search trees.

The project also includes extensive testing to validate the functionality, efficiency, and correctness of ZIP Trees. Comparative analysis with AVL Trees highlights the practical benefits and performance differences, with an emphasis on time complexity and structural balance.

By replicating and extending the theoretical insights into practical implementation, this project demonstrates the potential of ZIP Trees as an efficient and simplified alternative to traditional self-balancing trees.
